    ...
    : RustPlusSocket(server, port, playerId, playerToken, useFacepunchProxy), IRustPlus
{
    ...
    /// <summary>
    /// Processes a request that should be satisfied by a direct response message rather than a broadcast.
    /// </summary>
    protected async Task<Response<T?>> ProcessResponseRequestAsync<T>(AppRequest request, Func<AppMessage, T> successSelector)
    {
        var response = await SendRequestForResponseAsync(request);
    ...
    protected async Task<Response<T?>> GetEntityInfoAsync<T>(uint entityId, Func<AppMessage, T> selector)
    {
        ...
        return await ProcessResponseRequestAsync(request, selector);
    }
    ...
    public async Task<Response<SubscriptionInfo?>> CheckSubscriptionAsync(uint alarmId)
    {
        ...
        return await ProcessResponseRequestAsync<SubscriptionInfo?>(
            request,
    ...
    public async Task<Response<ServerInfo?>> GetInfoAsync()
    {
        ...
        return await ProcessResponseRequestAsync<ServerInfo?>(request, r => r.Response.Info.ToServerInfo());
    }
    ...
    public async Task<Response<ServerMap?>> GetMapAsync()
    {
        ...
        return await ProcessResponseRequestAsync<ServerMap?>(request, r => r.Response.Map.ToServerMap());
    }
    ...
    public async Task<Response<MapMarkers?>> GetMapMarkersAsync()
    {
        ...
        return await ProcessResponseRequestAsync<MapMarkers?>(request, r => r.Response.MapMarkers.ToMapMarkers());
    }
    ...
    public async Task<Response<TeamChatInfo?>> GetTeamChatAsync()
    {
        ...
        return await ProcessResponseRequestAsync<TeamChatInfo?>(
            request,
    ...
    public async Task<Response<TeamInfo?>> GetTeamInfoAsync()
    {
        ...
        return await ProcessResponseRequestAsync<TeamInfo?>(request, r => r.Response.TeamInfo.ToTeamInfo());
    }
    ...
    public async Task<Response<TimeInfo?>> GetTimeAsync()
    {
        ...
        return await ProcessResponseRequestAsync<TimeInfo?>(request, r => r.Response.Time.ToTimeInfo());
    }
    ...
    public async Task<Response<bool?>> PromoteToLeaderAsync(ulong steamId)
    {
        ...
        return await ProcessResponseRequestAsync<bool?>(request, r => r.Response.Success is not null);
    }
