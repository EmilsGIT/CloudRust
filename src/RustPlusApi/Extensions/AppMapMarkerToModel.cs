...
public static class AppMapMarkerToModel
{
    public static MapMarkers ToMapMarkers(this AppMapMarkers appMapMarker)
    {
        ...
        Dictionary<uint, UnknownMarker> travelingVendorMarkers = [];
        ...
        {
            if ((int)marker.Type == 9)
            {
                travelingVendorMarkers[marker.Id] = marker.ToUnknownMarker();
                continue;
            }
            ...
            switch (marker.Type)
            {
                ...
                case AppMarkerType.PatrolHelicopter:
                    ...
                    break;
                default:
                    Debug.WriteLine($"Unknown marker type ignored: {marker.Type}");
                    break;
            }
        }
        ...
        return new MapMarkers
        {
            ...
            TravelingVendorMarkers = travelingVendorMarkers,
