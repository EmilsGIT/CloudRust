    ...
    : RustPlusFcmSocket(credentials, persistentIds), IRustPlusFcm
{
    ...
    /// </summary>
    /// <remarks>
    /// The event data is a <see cref="Notification{T}"/> containing a <see cref="uint"/> entity ID.
    /// </remarks>
    public event EventHandler<Notification<uint?>>? OnSmartSwitchParing;
    ...
    /// The event data is a <see cref="Notification{T}"/> containing a <see cref="uint"/> entity ID.
    /// </remarks>
    public event EventHandler<Notification<uint?>>? OnSmartAlarmParing;
    ...
    /// The event data is a <see cref="Notification{T}"/> containing a <see cref="uint"/> entity ID.
    /// </remarks>
    public event EventHandler<Notification<uint?>>? OnStorageMonitorParing;
